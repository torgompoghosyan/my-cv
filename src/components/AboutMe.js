...
function AboutMe() {
    return (
        <div className='AboutMe'>
            ...
            <p>Hi!</p>
            <p>I am 24 years old and passionate about web development. I have completed several courses in JavaScript and have deepened my knowledge of React. I have a strong foundation in HTML and CSS, and I have mastered tools like Redux and Redux Toolkit for state management in applications. I enjoy coding and solving complex problems, and I am always eager to learn new technologies and improve my skills. Although I don’t have official work experience yet, I have created several projects that showcase my abilities, and you can explore them through the following links:
            </p>

            <ul className='my-project'>
                <li>
